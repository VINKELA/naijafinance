...
DJOSER = {
    ...
    # ... any other djoser settings you have
    # This is the Angular route the user will be sent to when they click the email link
...
# Allow your Angular frontend to talk to Django
...
# simplejwt: accept 'email' as the username field (matches AUTH_USER_MODEL)
...
# PostgreSQL (production) — falls back to SQLite for local dev if DATABASE_URL is unset
DATABASE_URL = os.getenv('DATABASE_URL', '')
if DATABASE_URL:
    DATABASES = {
        'default': {
            'ENGINE': 'django.db.backends.postgresql',
            'NAME': os.getenv('POSTGRES_DB', 'naijafinance'),
            'USER': os.getenv('POSTGRES_USER', 'naijafinance'),
...
DEFAULT_FROM_EMAIL = os.getenv('DEFAULT_FROM_EMAIL', 'hello@naijafinancehub.com')
SERVER_EMAIL = os.getenv('SERVER_EMAIL', DEFAULT_FROM_EMAIL)

# S5: recipient for pipeline ops-alert emails (e.g. scheduled ingest failures).
# Defaults to DEFAULT_FROM_EMAIL so alerts are deliverable with zero extra config.
ALERT_OPS_EMAIL = os.getenv('ALERT_OPS_EMAIL', DEFAULT_FROM_EMAIL)
