...
export interface Bond { id: number; symbol: string; name: string; last_price: string; asset_type: string; sector?: string | null; maturity_date?: string | null; coupon_rate?: string | null; price_history?: { date: string; price: number }[] | null; }
