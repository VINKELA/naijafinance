  ...
  template: `
    ...
    <div class="card" style="margin-bottom:20px;" *ngIf="detail()">
      ...
      <div style="margin-top:10px;">
        <span class="pill" [class.g]="!lang.isPidgin" style="cursor:pointer;" (click)="setLang('en')">EN</span>
        <span class="pill" [class.g]="lang.isPidgin" style="cursor:pointer;margin-left:6px;" (click)="setLang('pcm')">Pidgin</span>
      </div>
    </div>
...
export class FundDetailPage implements OnInit, AfterViewInit {
  ...
  constructor(private api: ApiService, private route: ActivatedRoute, public lang: LangService) {}

  t(): typeof STRINGS['en'] { return this.lang.isPidgin ? STRINGS['pcm'] : STRINGS['en']; }
  hasNav(): boolean { return (this.detail()?.chart_data?.length ?? 0) > 0; }
  setLang(l: 'en' | 'pcm') { const wantPidgin = l === 'pcm'; if (this.lang.isPidgin !== wantPidgin) this.lang.toggle(); }
